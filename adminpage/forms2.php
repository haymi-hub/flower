          ...
          <div class="form-three widget-shadow">
            <form class="form-horizontal"  action="" method="post">
              <div class="form-group">
                <label for="smallinput" class="col-sm-2 control-label label-input-sm">Flower Type Name</label>
                <div class="col-sm-8">
                  <input type="text" name="fname" class="form-control1 input-sm" id="smallinput" placeholder="Input Flower Type Name">
                </div>
              </div>
              <div class="form-group">
             ...
             <div class="col-sm-8"><input type="file" name="upload1" id="exampleInputFile"> </div>
            </div>  <div class="form-group">
              <label for="exampleInputFile" class="col-sm-2 control-label"></label>
              <div class="col-sm-8"><input type="file" name="upload2" id="exampleInputFile"> </div>
             </div>
                ...
                <div class="tables">
                  <div class="bs-example widget-shadow" data-example-id="hoverable-table">
                    <h4>Hover Rows Table:</h4>
                      <table class="datatable-1 table table-hover  table-bordered table-striped">
                         <thead>
                           <tr>
                             <th>#</th>
                             <th>Flower Type</th>
                            ...
                            <td><?php echo htmlentities($row['flower_type']);?></td>
...
if(isset($_POST['submit'])){
  ...
  $insert ="INSERT INTO  $try  (`flower_type`, `description`,`photo`,`photo1`,`photo2`)VALUES ('$ftype','$description','$pic','$pic1','$pic2')";
