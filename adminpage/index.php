          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="forms.html"><i class="fa fa-angle-right"></i>Upload Cut flower</a></li>
                  <li><a href="forms.html"><i class="fa fa-angle-right"></i>Upload Garden flower</a></li>
                  <li><a href="forms.html"><i class="fa fa-angle-right"></i>Upload occational flower</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="charts.html">
