...
<body>
                                                    ...
                                                    <nav>
                                                        <ul id="navigation">
                                                            ...
                                                            <li><a href="#">Business Lines<i class="ti-angle-down"></i></a>
                                                                <ul class="submenu">
                                                                        <li><a href="case_details.html">Flower Exporters</a></li>
                    ...
                    <div class="col-lg-8">
                        <form class="form-contact" action="" method="post" >
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="message" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Message'" placeholder="Enter your Message"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control" name="email"  type="email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter email address'" placeholder="Email">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <button type="submit" name="sub" class="button button-contactForm boxed-btn">Send</button>
                                                  </form>
                         </div>
                    </div>
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-xl-8">
                    <div class="info_text text-center">
                        ...
                        <a class="boxed-btn3" href="#">+251 913 000 000</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    if(isset($_POST['sub'])){
    	$msg=$_POST['message'];
    	$sender=$_POST['name'];  //receive input from user
      $email=$_POST['email'];
     ...
     echo ".$msg.";
      ...
      $insert ="INSERT INTO `message`  (`msg`, `sender`,`email`,`subject`)VALUES ('$msg','$sender','$email','$subject')";
