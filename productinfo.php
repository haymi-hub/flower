                                      ...
                                      <nav>
                                          <ul id="navigation">
                                              ...
                                              <li><a href="#">Flower <i class="ti-angle-down"></i></a>
                                                  <ul class="submenu">
                                                    <li><a href="Category.html">Cut Flower</a></li>
                                                    <li><a href="garden.html">Garden Flower</a></li>
                                                    <li><a href="occasional.html">Occasional Flower</a></li>
                                                  </ul>
                                              </li>
        ...
        <div class="product_image_area">
          <div class="container">
            <div class="row justify-content-center">
             ...
             include 'connect.php';
             $id=intval($_GET['id']);
              $nr1_query ="SELECT * FROM `flower_list` WHERE `id`=$id " ;
            ...
            while ($row = mysqli_fetch_assoc($res)){
              ...
              <div class="col-lg-12">
                <div class="slider_active owl-carousel" style=" margin-top: 100px; ">
                  <div class="single_case">
                    <img src="img/flower/poney32.png" alt="#" class="img-fluid">
                  </div>
                  <div class="single_case">
                    <img src="img/flower/poney32.png" alt="#" class="img-fluid">
                  </div>
              ...
              <div class="col-lg-8">
                <div class="single_product_text text-center">
                  <h3>Pink and White Lilies<br>
                      Miked Beautifull Flower</h3>
                  <p>
