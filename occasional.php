        ...
        <div class="case_study_area case_page">
            ...
            <div class="container">
                ...
                <div class="row grid" >
                      ...
                      $nr1_query ="SELECT * FROM `occation_flower` " ;
                      $res = mysqli_query($conn, $nr1_query);
                        while ($row = mysqli_fetch_assoc($res)){
                        //  $id = $row['cat_id'];
                              ?>
                    <div class="col-xl-4 grid-item cat<?php echo $row['cat_id'];?>">
                        <div class="single_case animated wobble duration-4000s" >
                            <div class="case_thumb">
                              <a href="single-product.php?id=<?php echo $row['id'];?>&cat=occation_flower&typ=occasional">
                                <img src="img/occasional/<?php echo $row['photo'];?>" alt="" width="362" height="240">
                              </a>
                                </div>
